# STM32 Architecture and Core Components - Code Examples

This directory contains all the code examples from **STM32 Architecture and Core Components** of the STM32 Embedded Systems Programming book.

## Code Examples

 1. **`code_example_17.c`** - Code Example 17
 2. **`code_example_18.c`** - Code Example 18
 3. **`code_example_19.c`** - Code Example 19
 4. **`code_example_20.c`** - Code Example 20
