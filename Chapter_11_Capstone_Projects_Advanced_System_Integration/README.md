# Capstone Projects Advanced System Integration - Code Examples

This directory contains all the code examples from **Capstone Projects Advanced System Integration** of the STM32 Embedded Systems Programming book.

## Code Examples

 1. **`code_example_46.c`** - Code Example 46
 2. **`code_example_47.c`** - Code Example 47
 3. **`code_example_48.c`** - Code Example 48
