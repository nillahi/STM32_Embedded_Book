# Introduction to Embedded Systems - Code Examples

This directory contains all the code examples from **Introduction to Embedded Systems** of the STM32 Embedded Systems Programming book.

## Code Examples

 1. **`code_example_01.c`** - Code Example 01
