# GPIO Programming and Digital IO - Code Examples

This directory contains all the code examples from **GPIO Programming and Digital IO** of the STM32 Embedded Systems Programming book.

## Code Examples

 1. **`code_example_26.c`** - Code Example 26
 2. **`code_example_27.c`** - Code Example 27
 3. **`code_example_28.c`** - Code Example 28
 4. **`code_example_29.c`** - Code Example 29
 5. **`code_example_30.c`** - Code Example 30
